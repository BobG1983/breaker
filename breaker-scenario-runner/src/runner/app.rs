...
/// Applies tile layout to the primary window based on [`TileConfig`] and primary monitor dimensions.
///
/// Reads the tile config resource and primary monitor component, computes tile
/// position using [`grid_dimensions`] and [`tile_position`], then sets the
