...
- [ ] Per-breaker base stats (speed, width, dash, bump windows) loaded from RON
- [ ] Remove universal bump speed modification from base system
- [ ] Aegis breaker (lives, bump speed triggered ability)
- [ ] Bolt-loss visual indicator for Aegis (lives display)
- [ ] System validates: adding a new breaker requires only RON data + a bolt-lost system
