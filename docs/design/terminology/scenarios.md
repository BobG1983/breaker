...
| **MutationKind** | Enum of mutation operations: `SetBreakerState`, `SetTimerRemaining`, `SpawnExtraEntities`, `MoveBolt`, `TogglePause`, `SetRunStat`, `DecrementRunStat`, `InjectOverStackedChip`, `InjectDuplicateOffers`, `InjectMaxedChipOffer`, `SpawnExtraSecondWindWalls`, `InjectZeroChargeShield`, `SpawnExtraPulseRings`, `InjectWrongEffectiveSpeed`, `SpawnExtraChainArcs`, `InjectMismatchedBoltAabb`, `SpawnExtraGravityWells`, `InjectWrongSizeMultiplier` | `MutationKind` |
