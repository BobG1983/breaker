...
- [Run Structure](run.md) — Tiers, nodes, transitions, difficulty curve, Mutator (umbrella for Protocol + Hazard)
...
- [Scenario Runner](scenarios.md) — Scenarios, invariants, input strategies, mutations
