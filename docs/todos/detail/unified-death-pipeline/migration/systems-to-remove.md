...
| `tick_bolt_lifespan` (death portion) | `src/bolt/systems/tick_bolt_lifespan.rs` | Modified, not removed — see [systems-to-modify/tick-bolt-lifespan.md](systems-to-modify/tick-bolt-lifespan.md) |
