...
### Remaining
- Wave 5 runtime behaviour for all custom-system protocols except those listed as delivered: remaining are afterimage, fission. (debt_collector, iron_curtain, echo_strike, siphon, greed, reckless_dash, burnout, conductor are done.)
