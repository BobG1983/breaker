...
pub(crate) use components::{
    ...
    CleanupOnNodeExit, CleanupOnRunEnd, NodeScalingFactor,  // lifecycle
...
- Shared: `CleanupOnNodeExit`, `CleanupOnRunEnd`, `NodeScalingFactor`, `BaseWidth`, `BaseHeight` (from `shared::components`)
