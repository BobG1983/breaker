...
- [folder-structure.md](folder-structure.md) — Target directory tree for src/effect_v3/
...
- [plugin-wiring/](plugin-wiring/index.md) — EffectV3Plugin, system sets, ordering
