...
On(Impact(Impactee), Fire(Vulnerable(2.0))) means "make the thing I just hit take double damage."

On(Death(Killer), Fire(SpeedBoost(1.5))) means "give the killer a speed boost."
