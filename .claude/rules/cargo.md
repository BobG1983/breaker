...
**Only runner agents execute cargo commands.** See `.claude/rules/tdd.md` Hard Rules for the cargo boundary rule.
...
| Task | Alias |
|------|-------|
| Type check | `cargo defaultscheck` |
...
| Task | Alias |
|------|-------|
| Type check | `cargo stateflowcheck` |
| Lint | `cargo stateflowclippy` |
| Test | `cargo stateflowtest` |
