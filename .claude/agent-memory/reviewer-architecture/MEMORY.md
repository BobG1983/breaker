...
- [Fireable quadtree + narrow-phase pattern](pattern_fireable_quadtree_narrow_phase.md) — query_circle_filtered broad phase + world.get::<T> narrow phase is canonical; NOT a rantzsoft-crates.md violation
...
- [Death bridge cross-domain ordering anchor — RESOLVED](known_gap_death_bridge_ordering_set.md) — EffectV3Systems::Death set added as cross-domain tag surface; ordering.md updated; volatile tests already consume .before(Death)
