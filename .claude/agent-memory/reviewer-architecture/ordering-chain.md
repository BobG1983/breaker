...
| BoltSystems::BreakerCollision | physics/sets.rs | bolt_breaker_collision | breaker (grade_bump) |
| BoltSystems::BoltLost | physics/sets.rs | bolt_lost | behaviors (bridge_bolt_lost) |
