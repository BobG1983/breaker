...
| `ApplyTimePenalty { seconds }` | `run/node/messages.rs` | `NodePlugin` | breaker/behaviors/time_penalty (observer) | run/node/apply_time_penalty |
| `SpawnAdditionalBolt` | `bolt/messages.rs` | `BoltPlugin` | breaker/behaviors/spawn_bolt (observer) | bolt/spawn_additional_bolt |
