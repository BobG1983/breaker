...
- `runner-linting/lint_patterns.md` (~116 lines, as of 2026-03-23) — warning range; grows ~10-15 lines per wave. Consider splitting into resolved-patterns.md (RESOLVED items) and active-patterns.md (open items) if it reaches 150.
