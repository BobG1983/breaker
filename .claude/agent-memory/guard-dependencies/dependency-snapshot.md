...
| syn | 2 | features=["full"] |
| quote | 1 | |
| proc-macro2 | 1 | flagged by machete (false positive for proc-macro crates) |

### breaker-scenario-runner direct dependencies
| Crate | Version | Notes |
|-------|---------|-------|
| bevy | 0.18.1 | default-features=false, features=["2d"] |
| breaker | path | activates dev feature via defaults (known issue) |
...
| ron | 0.11.0 | 0.12.0 | evaluate: Bevy 0.18 pulls 0.12 internally, causes split |
| tracing-subscriber | 0.3.22 | 0.3.23 | safe minor bump |
