...
## Patterns
- [pattern_config_default_vs_ron.md](pattern_config_default_vs_ron.md) — GameConfig derive: Rust Default impl may differ from RON file; tests use Rust Default (e.g. BoltConfig::default().radius=8.0, not 14.0 from RON)
...
- [pattern_message_capture.md](pattern_message_capture.md) — Capture MessageReader<T> into a Resource accumulator for assertion in integration tests
