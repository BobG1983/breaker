...
- CamelCase type names in doc comments MUST have backticks: `ChaosDriver`, `ScriptedInput`, `Vec`, etc.
...
/// ChaosDriver fires on action_prob frames.
...
```rust
// WRONG:
//! Input strategies — ChaosDriver and ScriptedInput.
