...
## Reference
- researcher-bevy-api memory: `.claude/agent-memory/researcher-bevy-api/` — already-verified facts; check here before looking up docs.rs
