...
- `dead_code` warnings (bolt/behaviors/mod.rs, bolt/behaviors/events.rs): `ArmedTriggers` and `OverclockEffectFired` (and its field) are re-exported/defined but unused — forward-declared for overclock wiring. Not errors.
