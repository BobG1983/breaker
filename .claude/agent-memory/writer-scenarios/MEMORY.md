...
- [Effect RON syntax reference](effect_ron_syntax.md) — EffectKind variants with their field names for RON
- [Adversarial patterns by mechanic](adversarial_patterns.md) — Effective adversarial techniques per effect/system domain
- [Effect RON syntax patterns (detailed)](pattern_effect_ron_syntax.md) — exact RON syntax for initial_effects, EffectKind variants, trigger chains
