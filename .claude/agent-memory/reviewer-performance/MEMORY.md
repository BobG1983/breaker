...
- [Volatile Wave 1 performance patterns](volatile_wave1_patterns.md) — Vec alloc, STAMP_SOURCE.to_owned(), VolatileCell archetype: all spawn-time, all acceptable; ExplodeConfig::fire() QueryState-per-call was pre-existing IMPORTANT — now RESOLVED by quadtree migration
