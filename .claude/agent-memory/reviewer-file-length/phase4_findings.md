...
| `effect/core/types/definitions/enums.rs` | 541 | 5 | 431 prod, unsplittable — NOTE: superseded by `effect_v3/types/` |
...
- effect/core/types/definitions/enums.rs (541) -- tightly coupled enum definitions — NOTE: superseded by `effect_v3/types/`
