...
- `effect_v3/types/` -- flat dir, one file per type (replaces old `effect/core/types/definitions/enums.rs`)
...
`effect/core/types/definitions/enums.rs` is superseded by `effect_v3/types/` (flat dir, one file per type).
