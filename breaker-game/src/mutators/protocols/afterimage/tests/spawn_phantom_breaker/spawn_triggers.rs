//! Spawn-trigger behaviors for `afterimage_spawn_phantom_breaker` —
//! Idle→Dashing rising-edge spawn, steady-state suppression, re-dash
//! despawn/respawn, and non-Dashing transitions.
...
use super::super::{
    ...
    helpers::{
        build_afterimage_app, phantom_breaker_count, seed_active_protocols_with_afterimage,
        spawn_breaker_with_dash, spawn_phantom_breaker_at,
    },
};
use crate::{
    breaker::{
