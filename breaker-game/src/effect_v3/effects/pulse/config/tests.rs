...
fn force_fire_on_next_tick(app: &mut App, entity: Entity) {
    app.world_mut()
        .get_mut::<crate::effect_v3::effects::pulse::components::PulseEmitter>(entity)
...
fn tick_pulse_snapshots_bolt_base_damage_into_pulse_ring_base_damage() {
    ...
    let _emitter = app
        ...
        .spawn((
            ...
            crate::effect_v3::effects::pulse::components::PulseEmitter {
                base_range:      64.0,
...
fn tick_pulse_via_fire_fires_exactly_one_ring_per_tick_when_dt_exceeds_interval() {
    ...
    app.world_mut()
        .get_mut::<crate::effect_v3::effects::pulse::components::PulseEmitter>(emitter)
    ...
    let timer = app
        .world()
        .get::<crate::effect_v3::effects::pulse::components::PulseEmitter>(emitter)
        .unwrap()
        .timer;
    assert!(
