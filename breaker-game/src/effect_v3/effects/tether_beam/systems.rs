...
pub(crate) fn tick_tether_beam(
    ...
    for (beam_entity, source, beam_damage, chip) in &beam_query {
        ...
        let beam_width = 10.0; // default beam half-width
...
mod tests {
    ...
    fn zero_damage_still_emits_message() {
        ...
        app.world_mut()
            .spawn((TetherBeamSource { bolt_a, bolt_b }, TetherBeamDamage(0.0)));
