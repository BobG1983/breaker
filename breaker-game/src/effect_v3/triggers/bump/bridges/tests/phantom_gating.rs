//! Phantom-breaker gating tests for the 9 bump bridges.
//!
...
use super::{
    super::system::{
        on_bump_occurred, on_bumped, on_early_bump_occurred, on_early_bumped,
        on_late_bump_occurred, on_late_bumped, on_perfect_bump_occurred, on_perfect_bumped,
    },
    helpers::*,
};
use crate::{
