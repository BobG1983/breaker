//! Shared test infrastructure for `impacted` bridge system tests.
...
pub(super) fn impacted_bolt_bound_effects() -> BoundEffects {
    BoundEffects(vec![(
        "test".into(),
        EffectNode::When {
...
pub(super) fn impacted_wall_bound_effects() -> BoundEffects {
    BoundEffects(vec![(
        "test".into(),
        EffectNode::When {
...
pub(super) fn impacted_breaker_bound_effects() -> BoundEffects {
    BoundEffects(vec![(
        "test".into(),
        EffectNode::When {
