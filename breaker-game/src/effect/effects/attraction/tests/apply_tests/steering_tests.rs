//! Tests for basic attraction steering behavior: direction, zero distance,
//! inactive entries, mixed active/inactive, multiple types, layer filtering,
//! no targets, no component, empty list, and force scaling with `dt`.
