//! Shared test infrastructure for explode tests: `DamageCellCollector`,
//! `damage_test_app`, `tick`, `spawn_test_cell`, and `spawn_explode_request`.
...
pub(super) fn spawn_explode_request(
    app: &mut App,
    x: f32,
    y: f32,
    range: f32,
